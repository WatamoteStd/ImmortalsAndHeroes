...
public static class EntityRegistry
{
        ...
        {EntityType.WolfWeak, new EntityData
            {
                ...
                HealthRegeneration = 1.3f, BaseMana = 30f, ManaRegeneration = 0.3f, BasicAttackTime = 1.15f, AbilitySlotCount = 1,
        ...
        {EntityType.Default, new EntityData
            {
                ...
                BaseDamage = 22f, AttackRange = 14f, AttackSpeed = 100, Armor = 0, MagicResistance = 0, BaseSpeed = 3f,
                HealthRegeneration = 2f, BaseMana = 100f, ManaRegeneration = 0.85f, BasicAttackTime = 1.6f, AbilitySlotCount = 6, TypeAttack = AttackType.Ranged,
        ...
        {EntityType.Male, new EntityData
            {
                ...
                HealthRegeneration = 2f, BaseMana = 100f, ManaRegeneration = 0.85f, BasicAttackTime = 1.6f, AbilitySlotCount = 6, TypeAttack = AttackType.Melee
            }
        }
    ...
    private static EntityData _baseData = new EntityData
    {
        ...
        BasicAttackTime = 5.0f, AbilitySlotCount = 1, TypeAttack = AttackType.Melee
    };
...
public readonly struct EntityData
    ...
    public required int AbilitySlotCount {get; init;}
    public required AttackType TypeAttack {get; init;}
    public ProjectileType Projectile {get; init;}
